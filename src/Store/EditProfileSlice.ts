...
export const editProfileName = (firstName: string, lastName: string, token: string) => async (dispatch: ThunkDispatch<{}, {}, any>) => {
    ...
    const editProfileSlice = createSlice({
        ...
        reducers: {
            editReducer: (state, action: PayloadAction<{ firstName: string; lastName: string }>) => {
